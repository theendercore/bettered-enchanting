...
import cutefox.bettered_enchanting.conditions.BumblezoneCompatCondition;
import cutefox.bettered_enchanting.conditions.NeoEnchantCompatCondition;
...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        BetteredEnchanting.LOGGER.info("Generating recipes for : " + BetteredEnchanting.MODID);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, BEItems.IRON_UPGRADE_SMITHING_TEMPLATE, 1)
                ...
                .offerTo(exporter, BetteredEnchanting.id(getRecipeName(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, BEItems.ENCHANTMENT_CATALYST, 1)
                ...
                .offerTo(exporter, BetteredEnchanting.id(getRecipeName(BEItems.ENCHANTMENT_CATALYST)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE, 1)
                ...
                .offerTo(exporter, BetteredEnchanting.id(getRecipeName(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE)));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.IRON_AXE)
                .criterion(hasItem(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("iron_axe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.IRON_PICKAXE)
                .criterion(hasItem(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("iron_pickaxe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.IRON_HOE)
                .criterion(hasItem(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("iron_hoe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.IRON_SHOVEL)
                .criterion(hasItem(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("iron_shovel_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.IRON_SWORD)
                .criterion(hasItem(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.IRON_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("iron_sword_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                ...
                .offerTo(exporter, BetteredEnchanting.id("diamond_gold_axe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                ...
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_gold_pickaxe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_HOE)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_gold_hoe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                ...
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_gold_shovel_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_SWORD)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_gold_sword_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                ...
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_gold_helmet_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                ...
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_gold_chestplate_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                ...
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_gold_leggings_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_BOOTS)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_gold_boots_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_AXE)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_iron_axe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_PICKAXE)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_iron_pickaxe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_HOE)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_iron_hoe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_SHOVEL)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_iron_shovel_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_SWORD)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_iron_sword_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_HELMET)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_iron_helmet_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_CHESTPLATE)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_iron_chestplate_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_LEGGINGS)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_iron_leggings_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(
                        ...
                        Items.DIAMOND_BOOTS)
                .criterion(hasItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(BEItems.DIAMOND_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(exporter, BetteredEnchanting.id("diamond_iron_boots_smithing"));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, BEItems.MAGIC_SHARD_DULL, 1)
                ...
                .criterion(hasItem(BEItems.INFUSED_LAPIS), conditionsFromItem(BEItems.INFUSED_LAPIS))
                .offerTo(exporter, BetteredEnchanting.id(getRecipeName(BEItems.MAGIC_SHARD_DULL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, BEItems.MAGIC_SHARD_FULL, 1)
                ...
                .criterion(hasItem(BEItems.INFUSED_LAPIS), conditionsFromItem(BEItems.INFUSED_LAPIS))
                .criterion(hasItem(BEItems.MAGIC_SHARD_DULL), conditionsFromItem(BEItems.MAGIC_SHARD_DULL))
                .offerTo(exporter, BetteredEnchanting.id(getRecipeName(BEItems.MAGIC_SHARD_FULL)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, BEItems.INFUSED_LAPIS, 1)
                ...
                .offerTo(exporter, BetteredEnchanting.id(getRecipeName(BEItems.INFUSED_LAPIS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, recipeItem, 1)
                ...
                .criterion(hasItem(BEItems.MAGIC_SHARD_FULL), conditionsFromItem(BEItems.MAGIC_SHARD_FULL))
                .offerTo(exporter, BetteredEnchanting.id(getRecipeName(recipeItem)));
