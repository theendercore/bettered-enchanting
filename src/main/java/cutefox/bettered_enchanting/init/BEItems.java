...
import cutefox.bettered_enchanting.item.ItemWithRemainderChance;
...
public class BEItems {
    ...
    public static void registerModItems() {
        BetteredEnchanting.LOGGER.info("Registering mod iems for : " + BetteredEnchanting.MODID);
    }
    ...
    private static Item registerItem(String id, Item item) {
        Item i = Registry.register(Registries.ITEM, BetteredEnchanting.id(id), item);
        MOD_ITEM_LIST.add(i);
        return i;
    }
